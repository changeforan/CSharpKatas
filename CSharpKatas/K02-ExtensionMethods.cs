...
namespace CSharpKatas
{
   ...
   {
       public static int? FindNumberOrDefault(this SomeoneElsesClass someOne, int i)
       {
           if (someOne == null) return null;
           var index =  someOne.Numbers.FindIndex(number => number == i);
           if (index == -1) return null;
           return someOne.Numbers[index];
       }
   }
